...
const labs = [
  { id: 1, title: 'Шифр Цезаря', description: 'Шифрование и дешифрование кириллического текста со сдвигом от 0 до 33. Отображение побуквенного преобразования с позициями в алфавите.', status: 'done' },
  { id: 2, title: 'Генерация простых чисел (BBS)', description: 'Генератор псевдослучайных последовательностей Blum Blum Shub с тестами на случайность (монобит, серии, длинные серии).', status: 'done' },
  { id: 3, title: 'Алгоритм шифрования DES', description: 'Симметричное блочное шифрование DES с анализом лавинного эффекта, слабых ключей, оценкой скорости и степени сжатия.', status: 'done' },
  { id: 4, title: 'Алгоритм Эль-Гамаля', description: 'Асимметричное шифрование на основе дискретного логарифма. Измерение времени вычисления y = a^x mod n и шифрование текстов.', status: 'done' },
